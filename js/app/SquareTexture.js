 ...
 */
define(["app/ShaderProgram","app/ImageTexture","app/NoiseFrame","lib/glMatrix-0.9.5.min"],function(ShaderProgram,ImageTexture,NoiseFrame){
    var SquareTexture = function(gl){
        var shaderProgram = new ShaderProgram(gl,"squaretexture");
